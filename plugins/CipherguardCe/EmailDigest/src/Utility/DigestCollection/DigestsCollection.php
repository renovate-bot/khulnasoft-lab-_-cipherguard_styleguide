...
use Cipherguard\EmailDigest\Utility\Digest\Digest;
...
{
    /**
     * @var \Cipherguard\EmailDigest\Utility\Digest\Digest[]
     */
     ...
     *
     * @param \Cipherguard\EmailDigest\Utility\Digest\AbstractDigestTemplate $digestTemplate digest template for this email queue
     * @param \Cake\ORM\Entity $emailQueue An email queue entity
     * @return \App\Model\Entity\User
     * @throws \Cipherguard\EmailDigest\Exception\UnsupportedEmailDigestDataException if the operator is not set or invalid
     */
     ...
     * @param \Cake\ORM\Entity $emailQueue An email queue entity
     * @return string
     * @throws \Cipherguard\EmailDigest\Exception\UnsupportedEmailDigestDataException if the full base url is not defined or empty
     */
     ...
     * @return \Cipherguard\EmailDigest\Utility\Digest\AbstractDigestTemplate return false if no digest in the pool supports the email data
     * @throws \Cipherguard\EmailDigest\Exception\UnsupportedEmailDigestDataException if no digest template was found for this email queue
     */
