 ...
 * @since         3.0.0
 */
namespace Cipherguard\EmailDigest\Utility\Digest;
...
class Digest
{
    ...
    /**
     * @var \Cipherguard\EmailDigest\Utility\Digest\AbstractDigestTemplate
     */
     ...
     * @param \Cipherguard\EmailDigest\Utility\Digest\AbstractDigestTemplate $template digest template used to render this digest
     */
    ...
    /**
     * @return \Cipherguard\EmailDigest\Utility\Digest\AbstractDigestTemplate
     */
