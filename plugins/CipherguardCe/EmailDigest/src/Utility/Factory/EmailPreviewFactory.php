...
use Cipherguard\EmailDigest\Utility\Mailer\EmailPreview;
...
class EmailPreviewFactory
{
     ...
     *
     * @param \Cipherguard\EmailDigest\Utility\Mailer\EmailDigestInterface $emailDigest Email digest to get a snapshot of
    ...
    private function renderFromEmailEntity(Entity $email): string
    {
        ...
        $renderer
            ...
            ->setVars($viewVars)
            ->setLayout('Cipherguard/EmailDigest.digest');
     ...
     * @return \Cipherguard\EmailDigest\Utility\Mailer\EmailDigest
     */
     ...
     *
     * @param \Cipherguard\EmailDigest\Utility\Digest\Digest $digest digest to render
     * @return \Cipherguard\EmailDigest\Utility\Mailer\EmailDigest
     */
     ...
     *
     * @param \Cipherguard\EmailDigest\Utility\Digest\Digest $digest digest
     * @return \Cipherguard\EmailDigest\Utility\Mailer\EmailDigest
     */
     ...
     *
     * @param \Cipherguard\EmailDigest\Utility\Mailer\EmailDigestInterface $emailDigest Email digest to use to render
     * @return string
     */
