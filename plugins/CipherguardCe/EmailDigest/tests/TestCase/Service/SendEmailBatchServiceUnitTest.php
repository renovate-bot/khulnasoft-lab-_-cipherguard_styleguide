...
use Cipherguard\EmailDigest\Test\Factory\GroupUserDeleteEmailQueueFactory;
use Cipherguard\EmailDigest\Test\Factory\ResourceDeleteEmailQueueFactory;
use Cipherguard\EmailDigest\Utility\Digest\DigestTemplateRegistry;
use Cipherguard\Locale\LocalePlugin;

/**
 * @covers \Cipherguard\EmailDigest\Service\SendEmailBatchService
 */
