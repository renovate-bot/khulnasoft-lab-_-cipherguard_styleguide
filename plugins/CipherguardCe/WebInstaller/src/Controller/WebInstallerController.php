 ...
 *
 * @package Cipherguard\WebInstaller\Controller
 */
class WebInstallerController extends Controller
{
     ...
     *
     * @var \Cipherguard\WebInstaller\Utility\WebInstaller
     */
    ...
    {
        $pluginEeEnabled = !empty(Configure::read('cipherguard.plugins.ee'));
