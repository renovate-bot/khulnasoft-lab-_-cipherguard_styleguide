 ...
 * @since         2.5.0
 */
namespace Cipherguard\WebInstaller\Middleware;
...
class WebInstallerMiddleware implements MiddlewareInterface
{
    ...
    /**
     * Check if cipherguard is configured.
    ...
    {
        if (Configure::read('cipherguard.webInstaller.configured') !== null) {
            return Configure::read('cipherguard.webInstaller.configured');
        }
        try {
