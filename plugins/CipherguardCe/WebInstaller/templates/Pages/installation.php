...
<div class="panel main ">
    ...
    <div class="panel middle">
        <?php echo $this->element('Cipherguard/WebInstaller.install/installing'); ?>
        <?php echo $this->element('Cipherguard/WebInstaller.install/complete'); ?>
        <?php echo $this->element('Cipherguard/WebInstaller.install/errors'); ?>
    </div>
    <?= $this->Form->end(); ?>
</div>
