 ...
 */
use Cipherguard\WebInstaller\View\Helper\HealthcheckHtmlHelper;

$healtcheck = new HealthcheckHtmlHelper();
?>
<?= $this->element('header', ['title' => __('Welcome to Cipherguard! Let\'s get started with the configuration.')]) ?>
        ...
        <div class="grid grid-responsive-12">
            <div class="row">
                <div class="col7">
                    ...
                    if ($data['system_ok']) :
                        ?>
                    <h2><?php echo __('Nice one! Your environment is ready for cipherguard.'); ?></h2>
                        <?php
                    else :
                        ?>
                    <h2><?php echo __('Oops!! Cipherguard cannot run yet on your server.'); ?></h2>
                        <?php
                    endif;
                    ?>
                    <?= $this->Flash->render() ?>
