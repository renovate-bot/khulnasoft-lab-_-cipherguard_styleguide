...
$this->assign('title', __('Cipherguard is not configured.'));
$this->Html->css('themes/default/api_webinstaller.min.css?v=' . Configure::read('cipherguard.version'), ['block' => 'css', 'fullBase' => true]);
    ...
    <div class="grid grid-responsive-12">
        <div class="row">
            <div class="col12 last intro">
                <h1><?= __('Cipherguard is not configured yet!') ?></h1>
                <h2><?= __('If you see this page, it means that cipherguard is present on your server but not configured. Click on "Get Started" to launch the configuration wizard.') ?></h2>
                <p>&nbsp;</p>
                <p>
