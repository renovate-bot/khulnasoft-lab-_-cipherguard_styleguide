...
use Cipherguard\EmailNotificationSettings\Utility\NotificationSettingsSource\ConfigEmailNotificationSettingsSource;
use Cipherguard\EmailNotificationSettings\Utility\NotificationSettingsSource\DbEmailNotificationSettingsSource;
...
class EmailNotificationSettings
{
    ...
    /**
     * Get notification settings from the config/default.php and config/cipherguard.php.
     *
     * @return array
     */
