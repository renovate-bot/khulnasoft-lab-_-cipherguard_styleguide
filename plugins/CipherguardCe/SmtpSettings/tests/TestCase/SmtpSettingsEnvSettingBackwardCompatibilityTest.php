...
class SmtpSettingsEnvSettingBackwardCompatibilityTest extends TestCase
{
    ...
    {
        putenv('CIPHERGURD_PLUGINS_SMTP_SETTINGS_ENABLED=0');
        putenv('CIPHERGURD_PLUGINS_SMTP_SETTINGS=1');
        Configure::load('default');
        $this->assertFalse($this->isFeaturePluginEnabled('SmtpSettings'));
        putenv('CIPHERGURD_PLUGINS_SMTP_SETTINGS_ENABLED');
        putenv('CIPHERGURD_PLUGINS_SMTP_SETTINGS');
    }

    public function data(): array
    {
        return [
            ['CIPHERGURD_PLUGINS_SMTP_SETTINGS_ENABLED', 1, true],
            ['CIPHERGURD_PLUGINS_SMTP_SETTINGS_ENABLED', 0, false],
            ['CIPHERGURD_PLUGINS_SMTP_SETTINGS', 1, true],
            ['CIPHERGURD_PLUGINS_SMTP_SETTINGS', 0, false],
            ['CIPHERGURD_PLUGINS_SMTP', 0, true],
        ];
    }
}
