 ...
 * @since         3.8.0
 */
namespace Cipherguard\SmtpSettings\Test\TestCase\Form;
...
class EmailConfigurationFormTest extends TestCase
{
    ...
    /**
     * @var \Cipherguard\SmtpSettings\Form\EmailConfigurationForm
     */
    private $form;
    ...
    {
        return [
            ['cipherguard', 'The client should be a valid IP or a valid domain.'],
