...
namespace Cipherguard\AccountSettings\Model\Table;
...
use Cipherguard\AccountSettings\Model\Table\Traits\ThemeSettingsTrait;

/**
 * AccountSettings Model
 *
 * @property \App\Model\Table\UsersTable&\Cake\ORM\Association\BelongsTo $Users
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting get($primaryKey, $options = [])
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting newEntity(array $data, array $options = [])
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting[] newEntities(array $data, array $options = [])
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting findOrCreate($search, ?callable $callback = null, $options = [])
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting newEmptyEntity()
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \Cipherguard\AccountSettings\Model\Entity\AccountSetting[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
...
class AccountSettingsTable extends Table
{
     ...
     * @return \Cipherguard\AccountSettings\Model\Entity\AccountSetting The first result from the ResultSet.
    ...
    public function getFirstPropertyOrFail(string $userId, string $property): AccountSetting
    {
        ...
        /** @var \Cipherguard\AccountSettings\Model\Entity\AccountSetting $entity */
    ...
    public function createOrUpdateSetting(string $userId, string $property, string $value): AccountSetting
    {
        ...
        /** @var \Cipherguard\AccountSettings\Model\Entity\AccountSetting|null $settingItem */
