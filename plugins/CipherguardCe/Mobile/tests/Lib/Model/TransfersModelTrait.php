 ...
 * @since         3.1.0
 */
namespace Cipherguard\Mobile\Test\Lib\Model;
...
trait TransfersModelTrait
{
    ...
    {
        /** @var \Cipherguard\Mobile\Model\Table\TransfersTable $transfersTable */
        $transfersTable = TableRegistry::getTableLocator()->get('Cipherguard/Mobile.Transfers');
        /** @var \Cipherguard\Mobile\Model\Entity\Transfer $transfer */
