...
namespace Cipherguard\Mobile\Service\Transfers;
 ...
 *
 * @package Cipherguard\Mobile\Service\Transfers
 */
class TransfersUpdateService
{
    /**
    ...
    /**
     * @var \Cipherguard\Mobile\Model\Table\TransfersTable table
     */
    public $Transfers;
     ...
     *
     * @param \Cipherguard\Mobile\Model\Table\TransfersTable|null $transfersTable table
    ...
    {
        $this->Transfers = $transfersTable ?? TableRegistry::getTableLocator()->get('Cipherguard/Mobile.Transfers');
     ...
     *
     * @param \Cipherguard\Mobile\Model\Entity\Transfer $transfer entity
     ...
     * @return \Cipherguard\Mobile\Model\Entity\Transfer
     */
     ...
     *
     * @param \Cipherguard\Mobile\Model\Entity\Transfer $original entity
     * @param \Cipherguard\Mobile\Model\Entity\Transfer $updated entity
     * @return void
     */
