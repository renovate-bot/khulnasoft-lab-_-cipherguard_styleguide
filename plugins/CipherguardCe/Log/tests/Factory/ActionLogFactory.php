 ...
 * ActionLogFactory
 *
 * @method \Cipherguard\Log\Model\Entity\ActionLog|\Cipherguard\Log\Model\Entity\ActionLog[] persist()
 * @method \Cipherguard\Log\Model\Entity\ActionLog getEntity()
 * @method \Cipherguard\Log\Model\Entity\ActionLog[] getEntities()
 * @method static \Cipherguard\Log\Model\Entity\ActionLog get($primaryKey, array $options = [])
 */
class ActionLogFactory extends CakephpBaseFactory
{
    ...
    {
        return 'Cipherguard/Log.ActionLogs';
    }
