...
use Cake\Log\Log;
use Cipherguard\Log\Strategy\ActionLogsErrorsOnlyQueryStrategy;
use Cipherguard\Log\Test\Factory\ActionLogFactory;
use Cipherguard\Log\Test\Lib\LogIntegrationTestCase;

/**
 * Class ActionLogsErrorsOnlyQueryStrategyTest
 */
class ActionLogsErrorsOnlyQueryStrategyTest extends LogIntegrationTestCase
{
    /**
     * @var string
     */
    ...
    public function setUp(): void
    {
        ...
        $config['strategy'] = ActionLogsErrorsOnlyQueryStrategy::class;
    ...
    public function testActionLogsErrorsOnlyQueryStrategy_On_File_Without_Error()
    {
        ...
        $this->assertFalse(file_exists($this->getLogFile()));
    }

    public function testActionLogsErrorsOnlyQueryStrategy_On_File_With_Internal_Error()
    {
