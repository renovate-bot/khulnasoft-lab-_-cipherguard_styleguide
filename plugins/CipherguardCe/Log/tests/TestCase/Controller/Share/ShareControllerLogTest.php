...
use Cipherguard\Log\Test\Lib\Traits\PermissionsHistoryTestTrait;
use Cipherguard\Log\Test\Lib\Traits\SecretsHistoryTestTrait;
...
class ShareControllerLogTest extends LogIntegrationTestCase
{
    ...
    /**
     * @var \Cipherguard\Log\Model\Table\PermissionsHistoryTable
     */
    ...
    /**
     * @var \Cipherguard\Log\Model\Table\SecretsHistoryTable
     */
    ...
    {
        parent::setUp();
        $this->PermissionsHistory = $this->fetchTable('Cipherguard/Log.PermissionsHistory');
        $this->Secrets = $this->fetchTable('Secrets');
        $this->SecretsHistory = $this->fetchTable('Cipherguard/Log.SecretsHistory');
    }
