...
/**
 * @property \Cipherguard\Log\Model\Table\ActionLogsTable&\Cake\ORM\Association\BelongsTo $ActionLogs
 * @property \Cipherguard\Log\Model\Table\PermissionsHistoryTable&\Cake\ORM\Association\BelongsTo $PermissionsHistory
 * @property \Cipherguard\Log\Model\Table\SecretsHistoryTable&\Cake\ORM\Association\BelongsTo $SecretsHistory
 * @property \App\Model\Table\ResourcesTable&\Cake\ORM\Association\BelongsTo $Resources
 * @property \Cipherguard\Log\Model\Table\SecretAccessesTable&\Cake\ORM\Association\BelongsTo $SecretAccesses
 * @method \Cipherguard\Log\Model\Entity\EntityHistory newEmptyEntity()
 * @method \Cipherguard\Log\Model\Entity\EntityHistory newEntity(array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\EntityHistory[] newEntities(array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\EntityHistory get($primaryKey, $options = [])
 * @method \Cipherguard\Log\Model\Entity\EntityHistory findOrCreate($search, ?callable $callback = null, $options = [])
 * @method \Cipherguard\Log\Model\Entity\EntityHistory patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\EntityHistory[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\EntityHistory|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Log\Model\Entity\EntityHistory saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Log\Model\Entity\EntityHistory[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \Cipherguard\Log\Model\Entity\EntityHistory[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \Cipherguard\Log\Model\Entity\EntityHistory[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \Cipherguard\Log\Model\Entity\EntityHistory[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
...
class EntitiesHistoryTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setEntityClass('Cipherguard\Log\Model\Entity\EntityHistory');
        ...
        $this->belongsTo('ActionLogs', [
            ...
            'className' => 'Cipherguard/Log.ActionLogs',
        ]);
        $this->belongsTo('PermissionsHistory', [
            'foreignKey' => 'foreign_key',
            'className' => 'Cipherguard/Log.PermissionsHistory',
        ]);
        $this->belongsTo('SecretsHistory', [
            'foreignKey' => 'foreign_key',
            'className' => 'Cipherguard/Log.SecretsHistory',
        ]);
        ...
        $this->belongsTo('SecretAccesses', [
            'foreignKey' => 'foreign_key',
            'className' => 'Cipherguard/Log.SecretAccesses',
        ]);
     ...
     * @return \Cipherguard\Log\Model\Entity\EntityHistory
     */
