...
use Cipherguard\Log\Model\Entity\SecretAccess;
 ...
 * @property \Cipherguard\Log\Model\Table\EntitiesHistoryTable&\Cake\ORM\Association\BelongsTo $EntitiesHistory
 * @method \Cipherguard\Log\Model\Entity\SecretAccess newEmptyEntity()
 * @method \Cipherguard\Log\Model\Entity\SecretAccess newEntity(array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\SecretAccess[] newEntities(array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\SecretAccess get($primaryKey, $options = [])
 * @method \Cipherguard\Log\Model\Entity\SecretAccess findOrCreate($search, ?callable $callback = null, $options = [])
 * @method \Cipherguard\Log\Model\Entity\SecretAccess patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
...
class SecretAccessesTable extends Table
{
     ...
     * @return \Cipherguard\Log\Model\Entity\SecretAccess
     */
