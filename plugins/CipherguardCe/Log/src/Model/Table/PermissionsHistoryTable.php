...
use Cipherguard\Log\Model\Entity\PermissionHistory;

/**
 * @property \Cipherguard\Log\Model\Table\EntitiesHistoryTable&\Cake\ORM\Association\HasOne $EntitiesHistory
 ...
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory newEmptyEntity()
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory newEntity(array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory[] newEntities(array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory get($primaryKey, $options = [])
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory findOrCreate($search, ?callable $callback = null, $options = [])
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \Cipherguard\Log\Model\Entity\PermissionHistory[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 */
class PermissionsHistoryTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setEntityClass('Cipherguard\Log\Model\Entity\PermissionHistory');
     ...
     * @return \Cipherguard\Log\Model\Entity\PermissionHistory
     */
