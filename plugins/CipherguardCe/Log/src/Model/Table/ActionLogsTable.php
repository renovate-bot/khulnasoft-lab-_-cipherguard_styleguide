 ...
 * @property \Cipherguard\Log\Model\Table\ActionsTable&\Cake\ORM\Association\BelongsTo $Actions
 * @property \Cipherguard\Log\Model\Table\EntitiesHistoryTable&\Cake\ORM\Association\HasMany $EntitiesHistory
 * @method \Cipherguard\Log\Model\Entity\ActionLog newEmptyEntity()
 * @method \Cipherguard\Log\Model\Entity\ActionLog newEntity(array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\ActionLog[] newEntities(array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\ActionLog get($primaryKey, $options = [])
 * @method \Cipherguard\Log\Model\Entity\ActionLog findOrCreate($search, ?callable $callback = null, $options = [])
 * @method \Cipherguard\Log\Model\Entity\ActionLog patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\ActionLog[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \Cipherguard\Log\Model\Entity\ActionLog|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Log\Model\Entity\ActionLog saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Log\Model\Entity\ActionLog[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \Cipherguard\Log\Model\Entity\ActionLog[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \Cipherguard\Log\Model\Entity\ActionLog[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \Cipherguard\Log\Model\Entity\ActionLog[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
...
class ActionLogsTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsTo('Actions', [
            ...
            'className' => 'Cipherguard/Log.Actions',
        ]);

        $this->hasMany('EntitiesHistory', [
            'foreignKey' => 'action_log_id',
            'className' => 'Cipherguard/Log.EntitiesHistory',
        ]);
    }
     ...
     * @return \Cipherguard\Log\Model\Entity\ActionLog|bool
    ...
    public function create(UserAction $userAction, int $status)
    {
        ...
        /** @var \Cipherguard\Log\Model\Entity\ActionLog|bool $logSaved */
     ...
     * @return \Cipherguard\Log\Model\Entity\ActionLog
     */
