...
use Cipherguard\JwtAuthentication\Authenticator\JwtRefreshTokenAuthenticator;
...
use Cipherguard\JwtAuthentication\Test\Factory\RefreshTokenAuthenticationTokenFactory;
...
class JwtRefreshTokenAuthenticatorTest extends TestCase
{
    ...
    private function assertSuccess(
        ...
        /** @var \Cipherguard\JwtAuthentication\Authenticator\RefreshTokenSessionIdentificationService $sessionIdentification */
