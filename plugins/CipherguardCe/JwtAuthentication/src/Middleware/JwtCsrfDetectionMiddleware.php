...
class JwtCsrfDetectionMiddleware implements MiddlewareInterface
{
     ...
     * @param \Cipherguard\JwtAuthentication\Service\Middleware\JwtRequestDetectionService $service Jwt Request Service
     * @return bool
     */
    ...
    {
        Configure::write(CsrfProtectionMiddleware::CIPHERGURD_SECURITY_CSRF_PROTECTION_ACTIVE_CONFIG, $isActive);
    }
}
