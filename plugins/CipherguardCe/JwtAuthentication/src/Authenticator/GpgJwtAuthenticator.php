...
class GpgJwtAuthenticator extends AbstractAuthenticator
{
    ...
    {
        /** @var \Cipherguard\JwtAuthentication\Authenticator\JwtArmoredChallengeInterface $armoredChallengeService */
     ...
     * @return void
     * @throws \Cipherguard\JwtAuthentication\Error\Exception\Challenge\InvalidDomainException if domain is invalid
     */
