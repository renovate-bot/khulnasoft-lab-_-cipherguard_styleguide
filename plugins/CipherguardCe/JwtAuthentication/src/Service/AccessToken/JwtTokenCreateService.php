...
class JwtTokenCreateService extends JwtAbstractService
{
    ...
    public const JWT_EXPIRY_CONFIG_KEY = 'cipherguard.auth.token.access_token.expiry';
     ...
     * @throws \Cipherguard\JwtAuthentication\Error\Exception\AccessToken\InvalidJwtKeyPairException if the JWT secret key is not readable.
     */
