...
class JwtKeyPairService
{
     ...
     *
     * @param \Cipherguard\JwtAuthentication\Service\AccessToken\JwtTokenCreateService|null $secretService JWT Secret Service
     * @param \Cipherguard\JwtAuthentication\Service\AccessToken\JwksGetService|null $publicService JWT Public Service
     */
     ...
     * @return void
     * @throws \Cipherguard\JwtAuthentication\Error\Exception\AccessToken\InvalidJwtKeyPairException if the pair could not be created.
     */
     ...
     * @return object
     * @throws \Cipherguard\JwtAuthentication\Error\Exception\AccessToken\InvalidJwtKeyPairException
     */
