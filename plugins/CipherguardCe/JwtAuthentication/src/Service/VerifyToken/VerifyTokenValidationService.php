 ...
 * @since         3.3.0
 */
namespace Cipherguard\JwtAuthentication\Service\VerifyToken;
...
{
    public const VERIFY_TOKEN_EXPIRY_CONFIG_KEY = 'cipherguard.auth.token.verify_token.expiry';
     ...
     * @return void
     * @throws \Cipherguard\JwtAuthentication\Error\Exception\VerifyToken\InvalidVerifyTokenException if version is not supported
     */
     ...
     * @return void
     * @throws \Cipherguard\JwtAuthentication\Error\Exception\VerifyToken\InvalidVerifyTokenException if the token is expired.
     */
     ...
     * @return void
     * @throws \Cipherguard\JwtAuthentication\Error\Exception\VerifyToken\InvalidVerifyTokenException if the format is not valid.
     ...
     * @param string $userId User ID
     * @return void
     * @throws \Cipherguard\JwtAuthentication\Error\Exception\VerifyToken\InvalidVerifyTokenException if the user ID is not a UUID.
     * @throws \Cake\ORM\Exception\PersistenceFailedException
     */
