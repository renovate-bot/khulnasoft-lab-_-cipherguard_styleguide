...
use Cipherguard\JwtAuthentication\Error\Exception\RefreshToken\UserDeactivatedException;
use Cipherguard\JwtAuthentication\Error\Exception\RefreshToken\UserDeletedException;
...
abstract class RefreshTokenAbstractService
{
    ...
    public const REFRESH_TOKEN_EXPIRY_CONFIG_KEY = 'cipherguard.auth.token.refresh_token.expiry';
