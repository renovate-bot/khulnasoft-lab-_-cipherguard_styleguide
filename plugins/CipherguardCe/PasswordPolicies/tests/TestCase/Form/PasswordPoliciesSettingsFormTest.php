 ...
 * @since         4.2.0
 */
namespace Cipherguard\PasswordPolicies\Test\TestCase\Form;

use App\Test\Lib\AppTestCase;
use App\Test\Lib\Model\FormatValidationTrait;
use Cake\Event\EventDispatcherTrait;
use Cipherguard\PasswordPolicies\Form\PasswordPoliciesSettingsForm;
use Cipherguard\PasswordPolicies\Model\Dto\PassphraseGeneratorSettingsDto;
use Cipherguard\PasswordPolicies\Model\Dto\PasswordPoliciesSettingsDto;
use Cipherguard\PasswordPolicies\Validation\PasswordGeneratorSettingsValidator;

/**
 * @covers \Cipherguard\PasswordPolicies\Form\PasswordPoliciesSettingsForm
 */
class PasswordPoliciesSettingsFormTest extends AppTestCase
{
    ...
    /**
     * @var \Cipherguard\PasswordPolicies\Form\PasswordPoliciesSettingsForm
     */
    private $form;
