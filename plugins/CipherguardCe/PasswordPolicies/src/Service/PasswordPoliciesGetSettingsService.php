...
class PasswordPoliciesGetSettingsService implements PasswordPoliciesGetSettingsInterface
{
     ...
     * - "file" if settings are defined using the password policy generator setting in the config file (cipherguard.php)
     * - "env" if settings are defined using the password policy generator setting in environment variable
     * - "legacyFile" if settings are defined using the legacy password generator setting in the config file (cipherguard.php)
