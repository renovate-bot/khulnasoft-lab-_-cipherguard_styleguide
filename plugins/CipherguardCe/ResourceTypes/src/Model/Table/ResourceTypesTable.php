...
namespace Cipherguard\ResourceTypes\Model\Table;
 ...
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType get($primaryKey, $options = [])
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType newEntity(array $data, array $options = [])
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType[] newEntities(array $data, array $options = [])
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType findOrCreate($search, ?callable $callback = null, $options = [])
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType newEmptyEntity()
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \Cipherguard\ResourceTypes\Model\Entity\ResourceType[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 */
