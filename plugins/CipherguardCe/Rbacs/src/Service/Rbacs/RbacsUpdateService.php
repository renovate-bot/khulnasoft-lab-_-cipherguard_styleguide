...
use Cipherguard\Rbacs\Model\Table\RbacsTable;

class RbacsUpdateService
{
    /**
     * @var \Cipherguard\Rbacs\Model\Table\RbacsTable $rbacsTable
     */
    ...
    {
        $this->rbacsTable = TableRegistry::getTableLocator()->get('Cipherguard/Rbacs.Rbacs');
    }

    /**
     * @param \App\Utility\UserAccessControl $uac user access control
     * @param \Cipherguard\Rbacs\Model\Dto\RbacsUpdateDtoCollection $dtoCollection collection of changes
    ...
    /**
     * @param \Cipherguard\Rbacs\Model\Dto\RbacsUpdateDtoCollection $dtoCollection [{id:<uuid>, control_function:<string>},...]
     * @return \Cake\Datasource\ResultSetInterface
     */
     ...
     * @param \Cipherguard\Rbacs\Model\Dto\RbacsUpdateDtoCollection $dtoCollection changes collection
     * @return void
     */
     ...
     * @param \Cipherguard\Rbacs\Model\Dto\RbacsUpdateDtoCollection $dtoCollection update set
     * @return array
     */
