 ...
 * Rbacs Model
 *
 * @method \Cipherguard\Rbacs\Model\Entity\Rbac get($primaryKey, $options = [])
 * @method \Cipherguard\Rbacs\Model\Entity\Rbac newEntity(array $data, array $options = [])
 * @method \Cipherguard\Rbacs\Model\Entity\Rbac[] newEntities(array $data, array $options = [])
 * @method \Cipherguard\Rbacs\Model\Entity\Rbac|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Rbacs\Model\Entity\Rbac saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Rbacs\Model\Entity\Rbac patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Cipherguard\Rbacs\Model\Entity\Rbac[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \Cipherguard\Rbacs\Model\Entity\Rbac findOrCreate($search, ?callable $callback = null, $options = [])
...
class RbacsTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->hasOne('Action', [
            'className' => 'Cipherguard/Logs.Actions',
        ...
        $this->hasOne('UiAction', [
            'className' => 'Cipherguard/Rbacs.UiActions',
            'bindingKey' => 'foreign_id',
            'foreignKey' => 'id',
            'conditions' => [
