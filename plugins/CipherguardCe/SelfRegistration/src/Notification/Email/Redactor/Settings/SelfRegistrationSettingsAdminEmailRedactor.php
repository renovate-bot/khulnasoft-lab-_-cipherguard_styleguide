...
namespace Cipherguard\SelfRegistration\Notification\Email\Redactor\Settings;
...
class SelfRegistrationSettingsAdminEmailRedactor implements SubscribedEmailRedactorInterface
{
    ...
    public const EMAIL_TEMPLATE = 'Cipherguard/SelfRegistration.Admin/settings_update';
