...
class SelfRegistrationUsersRegisterControllerTest extends AppIntegrationTestCase
{
    ...
    public function testSelfRegistrationUsersRegisterController_SelfRegistrationOpen_DataValid()
    {
        ...
        $emailSubject = "$firstName just created an account on cipherguard!";
        $emailContent = "$firstName $lastName used the self registration feature to create an account on cipherguard.";
        ...
        $this->assertEmailInBatchContains('You just created your account on cipherguard!', $username);
    }
