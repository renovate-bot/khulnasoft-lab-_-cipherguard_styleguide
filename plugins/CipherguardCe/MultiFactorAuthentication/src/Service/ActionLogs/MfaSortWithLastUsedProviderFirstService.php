 ...
 * @since         4.1.0
 */
namespace Cipherguard\MultiFactorAuthentication\Service\ActionLogs;
...
{
    public const SORT_BY_LAST_USAGE_CONFIG_NAME = 'cipherguard.plugins.multiFactorAuthentication.sortProvidersByLastUsage';
     ...
     *
     * @var \Cipherguard\Log\Model\Entity\ActionLog|false|null
     */
     ...
     * @return \Cipherguard\Log\Model\Entity\ActionLog|null
     */
    protected function queryAndCacheLastMfaVerifyInActionLogs(UserAccessControl $uac, array $actionIds): ?ActionLog
    {
        ...
        /** @var \Cipherguard\Log\Model\Entity\ActionLog|null $lastMfaRequestAction */
        $lastMfaRequestAction = TableRegistry::getTableLocator()
            ->get('Cipherguard/Log.ActionLogs')
            ->find()
