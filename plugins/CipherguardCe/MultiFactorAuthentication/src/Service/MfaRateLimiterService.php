...
class MfaRateLimiterService
{
    ...
    public function isFailedAttemptsExceeded(
        ...
        if (Configure::read('cipherguard.security.mfa.maxAttempts') < 1) {
            return false;
        }

        $actionLogsTable = $this->fetchTable('Cipherguard/Log.ActionLogs');
        ...
        return $failedAttemptsCount > Configure::read('cipherguard.security.mfa.maxAttempts');
    }
}
