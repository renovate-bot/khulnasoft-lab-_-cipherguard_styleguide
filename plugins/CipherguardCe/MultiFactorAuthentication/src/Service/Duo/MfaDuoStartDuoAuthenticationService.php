...
class MfaDuoStartDuoAuthenticationService
{
     ...
     * @return \Cipherguard\MultiFactorAuthentication\Model\Dto\MfaDuoAuthenticationRequestDto
    ...
    /**
     * Create the authentication token to use when Duo will respond with a callback to cipherguard. It will allow to authenticate the
     * user to cipherguard.
     *
     * @param \App\Utility\UserAccessControl $uac The user access control.
     * @param string|null $redirect The redirect path to store along the token. The user will be redirected to this
    ...
    /**
     * Create the authentication token that will be used when the Duo will respond with a callback to cipherguard to authenticate the user
