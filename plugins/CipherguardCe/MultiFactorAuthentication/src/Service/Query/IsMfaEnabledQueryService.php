...
namespace Cipherguard\MultiFactorAuthentication\Service\Query;
...
class IsMfaEnabledQueryService
{
     ...
     * @param \Cipherguard\MultiFactorAuthentication\Utility\MfaOrgSettings $mfaOrgSettings MfaOrgSettings
     * @return bool
     * @throws \Exception
     */
