...
use Cipherguard\MultiFactorAuthentication\Service\ActionLogs\MfaSortWithLastUsedProviderFirstService;
...
class MfaSettings
{
    ...
    /**
     * @var \Cipherguard\MultiFactorAuthentication\Utility\MfaAccountSettings
     */
    protected $accountSettings;

    /**
     * @var \Cipherguard\MultiFactorAuthentication\Utility\MfaOrgSettings
     */
    ...
    /**
     * @var \Cipherguard\MultiFactorAuthentication\Service\ActionLogs\MfaSortWithLastUsedProviderFirstService
     */
     ...
     *
     * @param \Cipherguard\MultiFactorAuthentication\Utility\MfaOrgSettings $orgSettings organization settings
     * @param \Cipherguard\MultiFactorAuthentication\Utility\MfaAccountSettings|null $accountSettings account settings
     * @param \App\Utility\UserAccessControl $uac user access control
     * @param \Cipherguard\MultiFactorAuthentication\Service\ActionLogs\MfaSortWithLastUsedProviderFirstService $sortProvidersService service sorting the providers with the last used first
     * @return void
     */
     ...
     * @return \Cipherguard\MultiFactorAuthentication\Utility\MfaAccountSettings|null
     */
     ...
     *
     * @return \Cipherguard\MultiFactorAuthentication\Utility\MfaOrgSettings
     */
