...
class MfaOrgSettings
{
    ...
    public static function get(): MfaOrgSettings
    {
        ...
        $configureSettings = Configure::read('cipherguard.plugins.multiFactorAuthentication');
        try {
     ...
     * Return the settings
     *
     * @return \Cipherguard\MultiFactorAuthentication\Service\MfaOrgSettings\MfaOrgSettingsDuoService
     */
