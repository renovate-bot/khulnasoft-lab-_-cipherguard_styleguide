...
class MfaUserSettingsResetEmailRedactor implements SubscribedEmailRedactorInterface
{
    ...
    public const TEMPLATE_SELF = 'Cipherguard/MultiFactorAuthentication.LU/mfa_user_settings_reset_self';
    public const TEMPLATE_ADMIN = 'Cipherguard/MultiFactorAuthentication.LU/mfa_user_settings_reset_admin';
