...
use Cipherguard\MultiFactorAuthentication\Service\Duo\MfaDuoCallbackAuthenticationTokenService;
...
class MfaDuoCallbackAuthenticationTokenServiceTest extends TestCase
{
    ...
    public function testMfaDuoCallbackAuthenticationTokenServiceTest_Success()
    {
        ...
        $this->assertEquals($verifiedAuthTokenData['user_agent'], 'CipherguardUA');
