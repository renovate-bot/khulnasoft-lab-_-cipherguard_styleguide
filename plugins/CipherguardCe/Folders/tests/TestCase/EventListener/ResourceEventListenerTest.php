...
namespace Cipherguard\Folders\Test\TestCase\EventListener;
...
/**
 * \Cipherguard\Folders\EventListener\ResourcesEventListener Test Case
 *
 * @covers \Cipherguard\Folders\EventListener\ResourcesEventListener
 */
class ResourceEventListenerTest extends FoldersIntegrationTestCase
{
    ...
    public function testFoldersResourcesEventListenerSuccess_AfterResourceAdded()
    {
        ...
        $this->assertEmailIsInQueue([
            'email' => 'ada@cipherguard.khulnasoft.com',
