...
/**
 * Cipherguard\Folders\Controller\Folders\FoldersViewController Test Case
 *
 * @uses \Cipherguard\Folders\Controller\Folders\FoldersViewController
 */
class FoldersViewControllerTest extends FoldersIntegrationTestCase
{
    ...
    public function testFoldersViewSuccess_ContainPermissionsGroup()
    {
        ...
        $this->assertSuccess();
        /** @var \Cipherguard\Folders\Model\Entity\Folder[] $result */
