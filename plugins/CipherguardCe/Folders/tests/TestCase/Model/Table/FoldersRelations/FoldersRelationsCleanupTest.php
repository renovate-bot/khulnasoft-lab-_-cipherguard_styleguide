...
namespace Cipherguard\Folders\Test\TestCase\Model\Table\FoldersRelations;
...
/**
 * Cipherguard\Folders\Model\Table\FoldersRelationsTable Test Case
 */
class FoldersRelationsCleanupTest extends FoldersTestCase
{
    ...
    public function testCleanupFoldersRelationsSoftDeletedResourcesSuccess()
    {
        ...
        $this->runCleanupChecks('Cipherguard/Folders.FoldersRelations', 'cleanupSoftDeletedResources', 2);
    ...
    public function testCleanupFoldersRelationsHardDeletedResourcesSuccess()
    {
        ...
        $this->runCleanupChecks('Cipherguard/Folders.FoldersRelations', 'cleanupHardDeletedResources', 2);
    ...
    public function testCleanupFoldersRelationsHardDeletedFoldersSuccess()
    {
        ...
        $this->runCleanupChecks('Cipherguard/Folders.FoldersRelations', 'cleanupHardDeletedFolders', 2);
    ...
    public function testCleanupFoldersRelationsHardDeletedFoldersParentsSuccess()
    {
        ...
        $this->runCleanupChecks('Cipherguard/Folders.FoldersRelations', 'cleanupHardDeletedFoldersParents', 2);
    ...
    public function testCleanupFoldersRelationsSoftDeletedUsersSuccess()
    {
        ...
        $this->runCleanupChecks('Cipherguard/Folders.FoldersRelations', 'cleanupSoftDeletedUsers', 2);
    ...
    public function testCleanupFoldersRelationsHardDeletedUsersSuccess()
    {
        ...
        $this->runCleanupChecks('Cipherguard/Folders.FoldersRelations', 'cleanupHardDeletedUsers', 2);
    ...
    public function testCleanupMissingFoldersFoldersRelationsSuccess()
    {
        ...
        $this->runCleanupChecks('Cipherguard/Folders.FoldersRelations', 'cleanupMissingFoldersFoldersRelations', 6, $cleanupOptions);
    ...
    public function testCleanupMissingResourcesFoldersRelationsSuccess()
    {
        ...
        $cleanupOptions = ['isDeleteCleanup' => false, 'cleanupCount' => 3];
        $this->runCleanupChecks('Cipherguard/Folders.FoldersRelations', 'cleanupMissingResourcesFoldersRelations', 6, $cleanupOptions);
    ...
    public function testCleanupDuplicatedFoldersRelations()
    {
        ...
        $this->runCleanupChecks('Cipherguard/Folders.FoldersRelations', 'cleanupDuplicatedFoldersRelations', 10, ['cleanupCount' => 6]);
