...
namespace Cipherguard\Folders\Test\TestCase\Model\Table\Folders;
...
/**
 * @covers \Cipherguard\Folders\Model\Table\FoldersTable
 */
class FoldersTableTest extends FoldersTestCase
{
    ...
    {
        parent::setUp();
        $this->Folders = TableRegistry::getTableLocator()->get('Cipherguard/Folders.Folders');
