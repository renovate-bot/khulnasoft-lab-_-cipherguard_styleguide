...
class FoldersUpdateServiceTest extends FoldersTestCase
{
    ...
    public function testUpdateFolderSuccess_NotifyUserAfterUpdate()
    {
        ...
        $this->assetEmailSubject('ada@cipherguard.khulnasoft.com', "You edited the folder $name");
        $this->assertEmailInBatchContains('You edited a folder', 'ada@cipherguard.khulnasoft.com');
        $this->assetEmailSubject('betty@cipherguard.khulnasoft.com', "Ada edited the folder $name");
        $this->assertEmailInBatchContains('Ada edited a folder', 'betty@cipherguard.khulnasoft.com');
    }
