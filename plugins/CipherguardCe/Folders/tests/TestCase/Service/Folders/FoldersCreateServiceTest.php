...
/**
 * Cipherguard\Folders\Service\Folders\FoldersCreateService Test Case
 *
 * @uses \Cipherguard\Folders\Service\Folders\FoldersCreateService
 */
class FoldersCreateServiceTest extends FoldersTestCase
{
    ...
    public function testCreateFolder_CommonSuccess_NotifyUserAfterCreate()
    {
        ...
        $this->assertEmailIsInQueue([
            ...
            'template' => 'Cipherguard/Folders.LU/folder_create',
        ]);
