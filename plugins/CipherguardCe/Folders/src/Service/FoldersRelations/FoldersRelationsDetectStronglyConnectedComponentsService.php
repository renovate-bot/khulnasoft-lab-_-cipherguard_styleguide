...
use Cipherguard\Folders\Utility\Tarjan;
...
class FoldersRelationsDetectStronglyConnectedComponentsService
{
     ...
     *
     * @return array<\Cipherguard\Folders\Model\Entity\FoldersRelation> The folders relations involved in the strongly connected components set.
     * @throws \Exception
     */
    ...
    /**
     * Check if a strongly component is valid as per cipherguard requirements. It is considered valid if it involves 1 or
     * 2 users.
     *
     ...
     * The function doesn't return an array of entities for performance reasons.
     *
     * @param array<\Cipherguard\Folders\Model\Entity\FoldersRelation> $foldersRelations The set of folders relations
     ...
     *   ...
     * ]
     * @return array<array<\Cipherguard\Folders\Model\Entity\FoldersRelation>> Array of SCCs containing folders relations involved
