...
class FoldersRelationsAddItemsToUserTreeService
{
    ...
    /**
     * @var \Cipherguard\Folders\Service\FoldersRelations\FoldersRelationsCreateService
     */
    private $foldersRelationsCreateService;

    /**
     * @var \Cipherguard\Folders\Service\FoldersRelations\FoldersRelationsDetectStronglyConnectedComponentsService
     */
    private $folderRelationsDetectSCCsService;

    /**
     * @var \Cipherguard\Folders\Service\FoldersRelations\FoldersRelationsRepairStronglyConnectedComponentsService
     */
    private $foldersRelationsRepairSCCsService;

    /**
     * @var \Cipherguard\Folders\Service\FoldersRelations\FoldersRelationsHaveAndAreChildrenService
     */
     ...
     * @param array<\Cipherguard\Folders\Model\Dto\FolderRelationDto> $items The collection of folder relation to add to the user tree.
     * @return void
     ...
     * @param \App\Utility\UserAccessControl $uac The user at the origin of the operation
     * @param string $userId The target user id the items are added for
     * @param \Cipherguard\Folders\Model\Collection\FolderRelationDtoCollection $items The list of items to add to the tree
     * @return array
     */
     ...
     *
     * @param string $userId The target user id the items are added for
     * @param \Cipherguard\Folders\Model\Collection\FolderRelationDtoCollection $items The items to look for potential parents
     * @return array<\Cipherguard\Folders\Model\Entity\FoldersRelation>
     */
     ...
     *
     * @param array<\Cipherguard\Folders\Model\Entity\FoldersRelation> $foldersRelations The folders relations to build a tuple comparison expression for
     ...
     *
     * @param string $userId The target user id the items are added for
     * @param array<\Cipherguard\Folders\Model\Entity\FoldersRelation> $foldersRelationsChanges The folders relations changes
     * @return void
     */
