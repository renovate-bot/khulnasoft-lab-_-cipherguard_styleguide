...
class FoldersRelationsSortService
{
     ...
     * - Created oldest
     *
     * @param array<\Cipherguard\Folders\Model\Entity\FoldersRelation> $foldersRelations The folders relations to sort
     ...
     *
     * @param \Cipherguard\Folders\Model\Entity\FoldersRelation $folderRelation The list of folders relations to sort.
     * @return string
     */
     ...
     * other one is not.
     *
     * @param \Cipherguard\Folders\Model\Entity\FoldersRelation $relationA The first folder relation to check the priority for.
     * @param \Cipherguard\Folders\Model\Entity\FoldersRelation $relationB The second folder relation to check the priority for.
