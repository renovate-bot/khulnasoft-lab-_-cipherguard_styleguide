...
use Cipherguard\Folders\Service\FoldersRelations\FoldersRelationsRemoveItemFromUserTreeService;
...
class FoldersShareService
{
    ...
    /**
     * @var \Cipherguard\Folders\Service\FoldersRelations\FoldersRelationsRemoveItemFromUserTreeService
     */
    ...
    {
        /** @var \Cipherguard\Folders\Model\Entity\Folder|null $folder */
     ...
     * @param \Cipherguard\Folders\Model\Entity\Folder $folder The folder to assert
     * @return void
     ...
     *
     * @param \App\Utility\UserAccessControl $uac The operator
     * @param \Cipherguard\Folders\Model\Entity\Folder $folder The target shared folder
     * @return void
     */
