 ...
 * @property \Cipherguard\Folders\Model\Table\FoldersTable&\Cake\ORM\Association\BelongsTo $Folders
 * @property \Cipherguard\Folders\Model\Table\FoldersTable&\Cake\ORM\Association\BelongsTo $FoldersParents
 * @property \App\Model\Table\UsersTable&\Cake\ORM\Association\BelongsTo $Users
 * @property \Cipherguard\Folders\Model\Table\FoldersRelationsHistoryTable&\Cake\ORM\Association\BelongsTo $FoldersRelationsHistory
 * @method \Cipherguard\Folders\Model\Entity\FoldersRelation get($primaryKey, $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FoldersRelation newEntity(array $data, array $options = [])
...
class FoldersRelationsTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsTo('Cipherguard/Folders.Folders', [
            'foreignKey' => 'foreign_id',
        ]);
        $this->belongsTo('Cipherguard/Folders.FoldersParents', [
     ...
     *
     * @param \Cipherguard\Folders\Model\Entity\FoldersRelation $foldersRelation The folder_relation to test
