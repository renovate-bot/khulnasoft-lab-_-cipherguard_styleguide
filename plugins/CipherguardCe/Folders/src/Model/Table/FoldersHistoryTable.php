 ...
 *
 * @method \Cipherguard\Folders\Model\Entity\FolderHistory get($primaryKey, ?array $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FolderHistory newEntity($data = null, ?array $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FolderHistory[] newEntities(array $data, ?array $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FolderHistory|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FolderHistory saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FolderHistory patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, ?array $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FolderHistory[] patchEntities($entities, array $data, ?array $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FolderHistory findOrCreate($search, callable $callback = null, ?array $options = [])
...
class FoldersHistoryTable extends Table
{
     ...
     * @return \Cipherguard\Folders\Model\Entity\FolderHistory
     */
