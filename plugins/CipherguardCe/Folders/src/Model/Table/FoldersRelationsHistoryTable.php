...
use Cipherguard\Folders\Model\Traits\FoldersRelations\FoldersRelationsFindersTrait;

/**
 * FoldersRelations Model
 *
 * @method \Cipherguard\Folders\Model\Entity\FoldersRelation get($primaryKey, ?array $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FoldersRelation newEntity($data = null, ?array $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FoldersRelation[] newEntities(array $data, ?array $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FoldersRelation|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FoldersRelation saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FoldersRelation patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, ?array $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FoldersRelation[] patchEntities($entities, array $data, ?array $options = [])
 * @method \Cipherguard\Folders\Model\Entity\FoldersRelation findOrCreate($search, callable $callback = null, ?array $options = [])
...
class FoldersRelationsHistoryTable extends Table
{
    ...
    {
        /** @var \Cipherguard\Folders\Model\Table\FoldersRelationsTable $foldersRelationsTable */
        $foldersRelationsTable = TableRegistry::getTableLocator()->get('Cipherguard/Folders.FoldersRelations');
