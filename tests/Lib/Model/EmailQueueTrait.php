...
trait EmailQueueTrait
{
    ...
    protected function setEmailNotificationsSetting(string $notificationSettingPath, bool $value): void
    {
        ...
        $this->backupEmailNotificationSettings = array_merge_recursive(
            Configure::read('cipherguard.email.send'),
            $this->backupEmailNotificationSettings
        );
        Configure::write('cipherguard.email.send.' . $notificationSettingPath, $value);
    }
    ...
    {
        Configure::write('cipherguard.email.send', $this->backupEmailNotificationSettings);
        EmailNotificationSettings::flushCache();
    }
    ...
    {
        $this->loadPlugins(array_merge($plugins, ['Cipherguard/Locale', 'Cipherguard/EmailDigest',]));
