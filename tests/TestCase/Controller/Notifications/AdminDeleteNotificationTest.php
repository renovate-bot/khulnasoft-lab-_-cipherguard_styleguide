...
class AdminDeleteNotificationTest extends AppIntegrationTestCase
{
    ...
    public function testAdminDeleteNotification_Success(): void
    {
        ...
        $this->assertEmailInBatchContains(
            "The administrator {$adminFullName} ({$adminDeleted->username}) is now deleted from the cipherguard organisation.",
            $operator->username
        );
        $this->assertEmailInBatchContains(
    ...
    public function testAdminDeleteNotification_DuplicateEmailNotSentToGroupManager(): void
    {
        ...
        $this->assertEmailInBatchContains(
            "The administrator {$adminFullName} ({$admin->username}) is now deleted from the cipherguard organisation.",
            $operator->username
        );
    ...
    public function testAdminDeleteNotification_GroupUserDeleteRedactorDisabled(): void
    {
        ...
        Configure::write('cipherguard.email.send.group.user.delete', false);
    ...
    public function testAdminDeleteNotification_SentToAdminWhoGotDeleted(): void
    {
        ...
        $this->assertEmailInBatchContains("{$operatorFullName} deleted you from the cipherguard organisation", $admin->username);
        $this->assertEmailInBatchNotContains('Log in cipherguard', $admin->username);
        // Admin is notified
        $this->assertEmailInBatchContains(
            "You deleted administrator {$adminFullName}",
            $operator->username
