...
class ResourcesUpdateNotificationWithStaticFixturesTest extends AppIntegrationTestCase
{
    ...
    public function testResourcesUpdateNotificationSuccess_Secrets(): void
    {
        ...
        $this->assertEmailInBatchContains('updated the password', 'ada@cipherguard.khulnasoft.com');
        $this->assertEmailInBatchContains('updated the password', 'betty@cipherguard.khulnasoft.com');
        $this->assertEmailInBatchContains('updated the password', 'carol@cipherguard.khulnasoft.com');
        $this->assertEmailInBatchContains('updated the password', 'dame@cipherguard.khulnasoft.com');
    }
}
