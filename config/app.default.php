...
return [
    ...
    'App' => [
        ...
        'jsBaseUrl' => 'js/',
        //
        // Customization of paths is not supported in cipherguard v3
    ...
    'EmailTransport' => [
        'default' => [
            ...
            /*
             * It is recommended to set these options through your environment or cipherguard.php
             */
    ...
    'Email' => [
        'default' => [
            ...
            'from' => [
                env('EMAIL_DEFAULT_FROM', 'you@localhost.test') => env('EMAIL_DEFAULT_FROM_NAME', 'Cipherguard')
            ],
            //'charset' => 'utf-8',
            //'headerCharset' => 'utf-8',
        ],
    ...
    'Datasources' => [
        'default' => [
            ...
            /*
             * Non default config
             * Cipherguard support setting these from environment variables
             * They can also be overridden in cipherguard.php
             */
     ...
     */
    'Session' => [
        'cookie' => env('SESSION_COOKIE', 'cipherguard_session'),
