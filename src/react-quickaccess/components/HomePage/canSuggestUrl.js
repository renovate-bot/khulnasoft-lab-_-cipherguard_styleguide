...
const parseSuggestedUrl = function(suggestedUrl) {
   ...
   * www.cipherguard.khulnasoft.com:443, then the port information is deleted after the parsing.
   */
 ...
 *
 * By instance for a given hostname: accounts.cipherguard.khulnasoft.com
 * The following hostnames should match:
 * - accounts.cipherguard.khulnasoft.com
 * - cipherguard.khulnasoft.com
 *
 * The following hostnames should not match:
 * - cipherguard.khulnasoft.com.attacker.com
 * - attacker-cipherguard.khulnasoft.com
 *
