...
class Application extends BaseApplication implements AuthenticationServiceProviderInterface
{
    ...
    /**
     * Setup the PSR-7 middleware cipherguard application will use.
     *
    ...
    public function middleware(MiddlewareQueue $middlewareQueue): MiddlewareQueue
    {
         ...
         * - Only allow assets to be loaded from the cipherguard instance domain
         ...
         */
        if (Configure::read('cipherguard.security.setHeaders')) {
    ...
    public function getSolutionBootstrapper(): BaseSolutionBootstrapper
    {
        if (is_null($this->solutionBootstrapper)) {
            $className = Configure::readOrFail('cipherguard.featurePluginAdder');
