...
class UserAdminRoleRevokedEmailRedactor implements SubscribedEmailRedactorInterface
{
    ...
    public const CONFIG_KEY_EMAIL_ENABLED = 'cipherguard.email.send.admin.user.adminRoleRevoked.admin';
    public const CONFIG_KEY_SEND_USER_EMAIL = 'cipherguard.email.send.admin.user.adminRoleRevoked.user';
