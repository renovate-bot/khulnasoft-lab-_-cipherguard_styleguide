...
class EmailSender
{
     ...
     * @param string|null $appFullBaseUrl Full base url of the Cipherguard instance
    ...
    public function __construct(
        ...
        $this->purifySubject = $purifySubject ?? Configure::read('cipherguard.email.purify.subject');
    }
