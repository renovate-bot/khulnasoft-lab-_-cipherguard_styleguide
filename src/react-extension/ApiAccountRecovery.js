 ...
 */
class ApiAccountRecovery extends Component {
  /**
   * Default constructor
  ...
  /**
   * Is the application ready to render.
   * @returns {boolean}
   */
  isReady() {
            ...
            <div id="container" className="container page login">
              <div className="content">
                <div className="header">
                  <div className="logo"><span className="visually-hidden">Cipherguard</span></div>
                </div>
...
export default ApiAccountRecovery;
