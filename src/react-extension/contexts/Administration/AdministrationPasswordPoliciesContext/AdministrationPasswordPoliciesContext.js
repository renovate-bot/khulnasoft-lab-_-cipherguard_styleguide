...
export const AdminPasswordPoliciesContext = React.createContext({
  ...
  getMinimalRequiredEntropy: () => {}, //returns the minimal entropy a generator must follow that Cipherguard requires
  getMinimalAdvisedEntropy: () => {}, //returns the minimal entropy advised by Cipherguard to have a secredt considered strong
...
export class AdminPasswordPoliciesContextProvider extends React.Component {
  ...
  get defaultState() {
    return {
      ...
      getMinimalRequiredEntropy: this.getMinimalRequiredEntropy.bind(this), //returns the minimal entropy a generator must follow that Cipherguard requires
      getMinimalAdvisedEntropy: this.getMinimalAdvisedEntropy.bind(this), //returns the minimal entropy advised by Cipherguard to have a secredt considered strong
  ...
  /**
   * Returns the minimal entropy a generator must follow that Cipherguard requires
   * @returns {number};
   */
  ...
  /**
   * Returns the minimal entropy advised by Cipherguard to have a secredt considered strong
   * @returns {number};
   */
