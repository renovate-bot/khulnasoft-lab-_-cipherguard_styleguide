...
describe("Sanitize URL checks", () => {
  it("Baseline checks", () => {
    ...
    expect(sanitizeUrl('cipherguard.khulnasoft.com')).toBe(false);
    ...
    expect(sanitizeUrl('https://cipherguard.khulnasoft.com')).not.toBe(false);
    expect(sanitizeUrl('https://www.cipherguard.khulnasoft.com')).not.toBe(false);
    expect(sanitizeUrl('https://www.cipherguard.khulnasoft.com/test')).not.toBe(false);
  });
  ...
  it("White listed protocols option", () => {
    ...
    expect(sanitizeUrl('http://cipherguard.khulnasoft.com', {whitelistedProtocols})).toBe(false);
    expect(sanitizeUrl('https://cipherguard.khulnasoft.com', {whitelistedProtocols})).toBe(false);
  });
