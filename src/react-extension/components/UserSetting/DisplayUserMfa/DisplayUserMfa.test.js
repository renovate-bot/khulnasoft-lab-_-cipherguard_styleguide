...
describe("As a user I should see the MFA settings page", () => {
  it("As a user I should see the MFA settings page if my Cipherguard instance is running under HTTPS", () => {
    expect.assertions(1);
  ...
  it("As a user I should see a message telling me I cannot configure my MFA as my Cipherguard instance is not running under HTTPS", () => {
    expect.assertions(2);
    const props = defaultAppContext({
