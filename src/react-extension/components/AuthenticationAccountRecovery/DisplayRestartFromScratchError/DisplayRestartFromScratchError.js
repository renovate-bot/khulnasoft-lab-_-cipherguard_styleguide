    ...
    return (
      <div className="setup-error">
        ...
        <p><Trans>You need to finalize the account recovery process with the same computer you used for the account recovery request.</Trans><br/><br/>
          <Trans>If you changed systems, or reinstalled cipherguard web extension in the meantime, you will need to start the account recovery process from scratch.</Trans></p>
