...
describe("See information", () => {
  ...
  describe(' As LU I can see information of a resource', () => {
    ...
    it('I should be able to identify each information name', async() => {
      ...
      expect(page.displayInformationList.modifiedBy(1).textContent).toBe('ada@cipherguard.khulnasoft.com');
      ...
      expect(page.displayInformationList.modifiedBy(2).textContent).toBe('ada@cipherguard.khulnasoft.com');
