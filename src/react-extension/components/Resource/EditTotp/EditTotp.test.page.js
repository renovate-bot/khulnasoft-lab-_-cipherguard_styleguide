...
/**
 * The EditTotp component represented as a page
 */
export default class EditTotpPage {
  /**
   * Default constructor
   ...
   */
  get dialog() {
    return this._page.container.querySelector('.edit-totp-dialog');
  }
  /**
   ...
   */
  get secretKey() {
    return this._page.container.querySelector('#edit-totp-form-key');
  }
   ...
   */
  get period() {
    return this._page.container.querySelector('#edit-totp-form-period');
  }
   ...
   */
  get digits() {
    return this._page.container.querySelector('#edit-totp-form-digits');
  }
   ...
   */
  get algorithm() {
    return this._page.container.querySelector('#edit-totp-form-algorithm .selected-value .value');
  }
   ...
   */
  get firstItemOption() {
    return this._page.container.querySelector('#edit-totp-form-algorithm .select-items .option');
  }
