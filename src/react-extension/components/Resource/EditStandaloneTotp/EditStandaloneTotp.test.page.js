...
/**
 * The EditStandaloneTotp component represented as a page
 */
export default class EditStandaloneTotpPage {
  /**
   * Default constructor
   ...
   */
  get dialog() {
    return this._page.container.querySelector('.edit-standalone-totp-dialog');
  }
  /**
   ...
   */
  get name() {
    return this._page.container.querySelector('#edit-standalone-totp-form-name');
  }
   ...
   */
  get uri() {
    return this._page.container.querySelector('#edit-standalone-totp-form-uri');
  }
   ...
   */
  get secretKey() {
    return this._page.container.querySelector('#edit-standalone-totp-form-key');
  }
   ...
   */
  get period() {
    return this._page.container.querySelector('#edit-standalone-totp-form-period');
  }
   ...
   */
  get digits() {
    return this._page.container.querySelector('#edit-standalone-totp-form-digits');
  }
   ...
   */
  get algorithm() {
    return this._page.container.querySelector('#edit-standalone-totp-form-algorithm .selected-value .value');
  }
   ...
   */
  get firstItemOption() {
    return this._page.container.querySelector('#edit-standalone-totp-form-algorithm .select-items .option');
  }
