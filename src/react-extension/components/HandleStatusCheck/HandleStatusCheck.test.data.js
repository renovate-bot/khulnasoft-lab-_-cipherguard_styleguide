...
export function defaultAccountRecoveryUserService(organizationAccountRecoveryPolicy) {
  return {
    getOrganizationAccountRecoverySettings: jest.fn(() => organizationAccountRecoveryPolicy)
  };
}

export function getOrganizationAccountRecoveryPolicy(data = {}) {
  const defaultData = {
    policy: "opt-in",
