...
class DeleteUserGroup extends Component {
  ...
  async delete() {
    ...
    try {
      ...
      await this.props.context.port.request("cipherguard.groups.delete", this.group.id);
      ...
      <DialogWrapper
        ...
        <form onSubmit={this.handleFormSubmit} noValidate>
          <div className="form-content">
            ...
            <p><Trans>This action cannot be undone. Users in this group may lose access to the content shared with it.</Trans></p>
          </div>
