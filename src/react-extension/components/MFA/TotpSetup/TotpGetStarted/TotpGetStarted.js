        ...
        <div className="row mfa-setup totp-get-started">
          <div className="col8 main-column how-it-works">
            ...
            <div className="instruction">
              <div className="step sign-in-illustration">
                ...
                <p><Trans>You sign in to cipherguard just like you normally do.</Trans></p>
              </div>
          ...
          <div className="col4 last">
            <div className="sidebar-help">
              ...
              <a className="button" href="https://help.cipherguard.khulnasoft.com/start" target="_blank" rel="noopener noreferrer">
                <Icon name="document" />
