      ...
      <div className="row">
                 ...
                 <div>
                   ...
                   <div className={`input text ad openldap ${this.hasAllInputDisabled() ? 'disabled' : ''}`}>
                     ...
                     <input id="field-mapping-openldap-group-users-input" type="text" aria-required={true} name="users" value={settings.fieldsMapping.openldap.group.users}
                       ...
                       disabled={this.hasAllInputDisabled()}/>
                     <div className="help-message"><Trans>Directory group&apos;s users field to map to Cipherguard group&apos;s field.</Trans></div>
                 ...
                 {this.isActiveDirectoryChecked() &&
                   <div className={`input text ad openldap ${this.hasAllInputDisabled() ? 'disabled' : ''}`}>
                     ...
                     <input id="field-mapping-ad-user-username-input" type="text" aria-required={true} name="username" value={settings.fieldsMapping.ad.user.username}
                       ...
                       disabled={this.hasAllInputDisabled()}/>
                     <div className="help-message"><Trans>Directory user&apos;s username field to map to Cipherguard user&apos;s username field.</Trans></div>
        ...
        <div className="col4 last">
          ...
          <div className="sidebar-help">
            ...
            <a className="button" href="https://help.cipherguard.khulnasoft.com/configure/ldap" target="_blank" rel="noopener noreferrer">
              <Icon name="document"/>
