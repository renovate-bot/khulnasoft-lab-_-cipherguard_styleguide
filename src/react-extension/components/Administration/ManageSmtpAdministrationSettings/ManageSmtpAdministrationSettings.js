        ...
        <div className="row">
          ...
          <div className="col4 last">
            ...
            <div className="sidebar-help">
              ...
              <p><Trans>Cipherguard needs an smtp server in order to send invitation emails after an account creation and to send email notifications.</Trans></p>
              <a className="button" href="https://help.cipherguard.khulnasoft.com/configure/email/setup" target="_blank" rel="noopener noreferrer">
                <Icon name="document"/>
