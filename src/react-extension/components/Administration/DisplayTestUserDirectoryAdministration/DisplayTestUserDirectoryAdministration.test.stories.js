    ...
    userDirectoryTestResult: {
      "users": [
        ...
        },
        {
          ...
          "directory_name": "CN=Ada Lovelalce,OU=CipherguardUsers,DC=passbolt,DC=local",
        ...
        },
        {
          ...
          "directory_name": "CN=Betty Holberton,OU=CipherguardUsers,DC=passbolt,DC=local",
        ...
        },
        {
          ...
          "directory_name": "CN=Zoe Logos,OU=CipherguardUsers,DC=passbolt,DC=local",
        ...
        },
        {
          ...
          "directory_name": "CN=Sofia Kovalevskaya,OU=CipherguardUsers,DC=passbolt,DC=local",
        ...
        },
        {
          ...
          "directory_name": "CN=maxence zanardo,OU=CipherguardUsers,DC=passbolt,DC=local",
      ...
      "groups": [
        ...
        },
        {
          ...
          "directory_name": "CN=Finance,OU=CipherguardUsers,DC=passbolt,DC=local",
          "directory_created": "2018-07-09T04:03:14+00:00",
          "directory_modified": "2019-02-05T11:12:05+00:00",
          "group": {
            "name": "Finance",
            "members": [
              "CN=Test1,OU=CipherguardUsers,DC=passbolt,DC=local",
              "CN=Zoe Logos,OU=CipherguardUsers,DC=passbolt,DC=local"
            ],
            "groups": [
              "CN=Test1,OU=CipherguardUsers,DC=passbolt,DC=local"
            ],
        ...
        },
        {
          ...
          "directory_name": "CN=Operations,OU=CipherguardUsers,DC=passbolt,DC=local",
          "directory_created": "2018-07-09T04:03:51+00:00",
          "directory_modified": "2019-02-06T19:07:16+00:00",
          "group": {
            "name": "Operations",
            "members": [
              "CN=Finance,OU=CipherguardUsers,DC=passbolt,DC=local",
              "CN=Zoe Logos,OU=CipherguardUsers,DC=passbolt,DC=local",
              "CN=Ada Lovelalce,OU=CipherguardUsers,DC=passbolt,DC=local"
            ],
            "groups": [
              "CN=Finance,OU=CipherguardUsers,DC=passbolt,DC=local"
            ],
        ...
        },
        {
          ...
          "directory_name": "CN=DevOps,OU=CipherguardUsers,DC=passbolt,DC=local",
        ...
        },
        {
          ...
          "directory_name": "CN=Test1,OU=CipherguardUsers,DC=passbolt,DC=local",
          "directory_created": "2019-02-05T11:12:05+00:00",
          "directory_modified": "2019-02-05T11:12:36+00:00",
          "group": {
            "name": "Test1",
            "members": [
              "CN=Test2,OU=CipherguardUsers,DC=passbolt,DC=local"
            ],
            "groups": [
              "CN=Test2,OU=CipherguardUsers,DC=passbolt,DC=local"
            ],
        ...
        },
        {
          ...
          "directory_name": "CN=Test2,OU=CipherguardUsers,DC=passbolt,DC=local",
        ...
        },
        {
          ...
          "directory_name": "CN=TestGroup,OU=CipherguardUsers,DC=passbolt,DC=local",
        ...
        },
        {
          ...
          "directory_name": "CN=Administration,OU=CipherguardGroups,DC=passbolt,DC=local",
        ...
        },
        {
          ...
          "directory_name": "CN=Developers,OU=CipherguardGroups,DC=passbolt,DC=local",
        ...
        },
        {
          ...
          "directory_name": "CN=MyParentGroup,OU=CipherguardGroups,DC=passbolt,DC=local",
          "directory_created": "2020-11-01T18:53:53+00:00",
          "directory_modified": "2020-11-01T18:54:39+00:00",
          "group": {
            "name": "MyParentGroup",
            "members": [
              "CN=Developers,OU=CipherguardGroups,DC=passbolt,DC=local",
              "CN=Administration,OU=CipherguardGroups,DC=passbolt,DC=local"
            ],
            "groups": [
              "CN=Developers,OU=CipherguardGroups,DC=passbolt,DC=local",
              "CN=Administration,OU=CipherguardGroups,DC=passbolt,DC=local"
      ...
      "tree": {
        ...
        "CN=Operations,OU=CipherguardUsers,DC=passbolt,DC=local": {
          "type": "group",
          "id": "91ea4dda-8925-4799-8b0a-279b9cde0610",
          "directory_name": "CN=Operations,OU=CipherguardUsers,DC=passbolt,DC=local",
          "directory_created": "2018-07-09T04:03:51+00:00",
        ...
        "CN=DevOps,OU=CipherguardUsers,DC=passbolt,DC=local": {
          "type": "group",
          "id": "5f3d705a-6234-4929-95e6-0cf32a866325",
          "directory_name": "CN=DevOps,OU=CipherguardUsers,DC=passbolt,DC=local",
          "directory_created": "2018-08-22T08:27:00+00:00",
        ...
        "CN=TestGroup,OU=CipherguardUsers,DC=passbolt,DC=local": {
          "type": "group",
          "id": "b6c6ab17-c5cf-41f1-8e1b-c7915a69bcce",
          "directory_name": "CN=TestGroup,OU=CipherguardUsers,DC=passbolt,DC=local",
          "directory_created": "2019-11-19T14:22:01+00:00",
        ...
        "CN=MyParentGroup,OU=CipherguardGroups,DC=passbolt,DC=local": {
          "type": "group",
          "id": "3a9bb88f-79a7-4d16-a0dc-aae560f3099e",
          "directory_name": "CN=MyParentGroup,OU=CipherguardGroups,DC=passbolt,DC=local",
          "directory_created": "2020-11-01T18:53:53+00:00",
        ...
        "CN=Betty Holberton,OU=CipherguardUsers,DC=passbolt,DC=local": {
          "type": "user",
          "id": "aa4204c8-e474-4df3-a7cb-d4a754b03c0c",
          "directory_name": "CN=Betty Holberton,OU=CipherguardUsers,DC=passbolt,DC=local",
          "directory_created": "2018-07-09T03:57:38+00:00",
        ...
        "CN=Sofia Kovalevskaya,OU=CipherguardUsers,DC=passbolt,DC=local": {
          "type": "user",
          "id": "16789f75-2cf7-4755-9bd9-634d1ff42240",
          "directory_name": "CN=Sofia Kovalevskaya,OU=CipherguardUsers,DC=passbolt,DC=local",
          "directory_created": "2018-07-09T03:58:58+00:00",
        ...
        "CN=maxence zanardo,OU=CipherguardUsers,DC=passbolt,DC=local": {
          "type": "user",
          "id": "f8b5860e-8280-4bdc-9ec9-de7e49810084",
          "directory_name": "CN=maxence zanardo,OU=CipherguardUsers,DC=passbolt,DC=local",
          "directory_created": "2020-09-03T15:48:04+00:00",
