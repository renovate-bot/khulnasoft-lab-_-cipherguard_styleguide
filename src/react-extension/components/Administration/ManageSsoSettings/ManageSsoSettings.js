              ...
              {ssoConfig?.provider === "azure" &&
                <>
                  ...
                  <div className={`input text required ${this.hasAllInputDisabled() ? 'disabled' : ''}`}>
                    ...
                    <p>
                      <Trans>Allows Azure and Cipherguard API to securely share information.</Trans> <a href="https://learn.microsoft.com/en-us/azure/marketplace/create-or-update-client-ids-and-secrets#add-a-client-id-and-client-secret" rel="noopener noreferrer" target="_blank"><Trans>Where to find it?</Trans></a>
                    </p>
                  </div>
                  ...
                  {this.state.advancedSettingsOpened &&
                    <>
                      <div className={`select-wrapper input required ${this.hasAllInputDisabled() ? 'disabled' : ''}`}>
                        ...
                        <p><Trans>Defines which Azure field needs to be used as Cipherguard username.</Trans></p>
                      </div>
              ...
              {ssoConfig?.provider === "google" &&
                <>
                  ...
                  <div className={`input text required ${this.hasAllInputDisabled() ? 'disabled' : ''}`}>
                    ...
                    <p>
                      <Trans>Allows Google and Cipherguard API to securely share information.</Trans> <a href="https://developers.google.com/identity/openid-connect/openid-connect#authenticationuriparameters" rel="noopener noreferrer" target="_blank"><Trans>Where to find it?</Trans></a>
                    </p>
                  </div>
                </>
              }
              {ssoConfig?.provider === "oauth2" &&
                <>
                  ...
                  <div className={`input text required ${this.hasAllInputDisabled() ? 'disabled' : ''}`}>
                    ...
                    <p>
                      <Trans>Allows your OAuth2 provider and Cipherguard API to securely share information.</Trans>
                    </p>
                  </div>
                </>
              }
        ...
        <div className="col4 last">
          <div className="sidebar-help warning message" id="sso-setting-security-warning-banner">
            ...
            <p>
              ...
              <a href="https://help.cipherguard.khulnasoft.com/configure/sso" target="_blank" rel="noopener noreferrer"><Trans>Learn more</Trans></a>
            </p>
          </div>
          <div className="sidebar-help">
            ...
            <a className="button" href="https://help.cipherguard.khulnasoft.com/configure/sso" target="_blank" rel="noopener noreferrer">
              <Icon name="document"/>
