      ...
      <div className="row">
        <div className="password-policies-settings col8 main-column">
          ...
          {this.isWeakSettings(settings) &&
            <div className="warning message" id="user-passphrase-policies-weak-settings-banner">
              <p>
                <Trans>Cipherguard recommends passphrase strength to be at minimum of {{MINIMAL_ADVISED_ENTROPY}} bits to be safe.</Trans>
              </p>
            </div>
          }
          ...
          <span className="input toggle-switch form-element">
            <Trans>Allow cipherguard to access external services to check if the user passphrase has been compromised when the user creates it.</Trans>
          </span>
        ...
        <div className="col4 last">
          <div className="sidebar-help">
            ...
            <a className="button" href="https://help.cipherguard.khulnasoft.com/configure/user-passphrase-policies" target="_blank" rel="noopener noreferrer">
              <Icon name="life-ring"/>
