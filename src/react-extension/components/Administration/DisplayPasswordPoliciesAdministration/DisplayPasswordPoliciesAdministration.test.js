...
describe("DisplayPasswordPoliciesAdministration", () => {
  ...
  describe("As an administrator I can read password policies settings of my organization", () => {
    ...
    it('As a logged in administrator I can see an help box in the password policy administration screen ', async() => {
      ...
      expect(page.helpBoxButton.getAttribute('href')).toEqual('https://help.cipherguard.khulnasoft.com/configure/password-policies');
    });
  });
  ...
  describe("As an administrator I can update the password policies settings of my organization", () => {
    ...
    it("As a logged in administrator I should see an error message if I try to save passphrase generator settings that leads to have entropies that are under the minimum Cipherguard's requirement", async() => {
      expect.assertions(1);
    ...
    it("As a logged in administrator I should see an error message if I try to save password generator settings that leads to have entropies that are under the minimum Cipherguard's requirement", async() => {
      expect.assertions(1);
