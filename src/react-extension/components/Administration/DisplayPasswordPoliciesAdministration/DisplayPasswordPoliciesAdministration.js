...
class DisplayPasswordPoliciesAdministration extends React.Component {
  ...
  async componentDidMount() {
    this.props.administrationWorkspaceContext.setDisplayAdministrationWorkspaceAction(DisplayAdministrationPasswordPoliciesActions);
    ...
    return (
      <div className="row">
        <div className="password-policies-settings col8 main-column">
          <h3 id="password-policies-settings-title"><Trans>Password Policy</Trans></h3>
          ...
          {adminContext.hasSettingsChanges() &&
            <div className="warning message" id="password-policies-setting-banner">
              <p>
          ...
          {isPasswordEntropyTooLow &&
            <div className="warning message" id="minimal-password-entropy-advised-banner">
              <p>
                ...
                <Trans>Cipherguard recommends a minimum of {{minimalAdvisedEntropy}} bits to be safe.</Trans>
              </p>
            </div>
          }
          ...
          {this.state.showPassphraseSection && <div className="passphrase-settings">
            ...
            <div className={`input text ${this.hasAllInputDisabled() ? 'disabled' : ''}`}>
              ...
              {errors.wordsSeparator &&
                <div className="error-message">{errors.wordsSeparator}</div>
              }
            </div>
        ...
        <div className="col4 last">
          ...
          <div className="sidebar-help">
            ...
            <a className="button" href="https://help.cipherguard.khulnasoft.com/configure/password-policies" target="_blank" rel="noopener noreferrer">
              <Icon name="life-ring"/>
...
export default withAppContext(withAdministrationWorkspace(withAdminPasswordPolicies(withTranslation('common')(DisplayPasswordPoliciesAdministration))));
