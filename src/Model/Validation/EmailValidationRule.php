...
final class EmailValidationRule extends CipherguardValidationRule
{
    public const MX_CHECK_KEY = 'cipherguard.email.validate.mx';
    public const REGEX_CHECK_KEY = 'cipherguard.email.validate.regex';
