...
class UsersRegisterController extends AppController
{
     ...
     * @param \Cipherguard\SelfRegistration\Service\DryRun\SelfRegistrationDryRunServiceInterface $dryRunService Service to assess to availability of self registration
     * @return void
    ...
    /**
     * @param \Cipherguard\SelfRegistration\Service\DryRun\SelfRegistrationDryRunServiceInterface $dryRunService dry run service
     * @return void
