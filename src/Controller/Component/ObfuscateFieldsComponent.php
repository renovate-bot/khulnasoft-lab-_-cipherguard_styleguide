...
class ObfuscateFieldsComponent extends Component
{
     ...
     * Default placeholder
     */
    public const FIELD_PLACEHOLDER = '__CIPHERGURD_OBFUSCATE_FIELDS_COMPONENT_PLACEHOLDER__';
    ...
    public function initialize(array $config): void
    {
        ...
        if (empty($config['placeholder'])) {
            $this->setConfig(
                'placeholder',
                Configure::read('cipherguard.obfuscateFields.placeholder', self::FIELD_PLACEHOLDER)
            );
        }
    }
