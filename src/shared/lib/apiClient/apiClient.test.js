...
describe("Unit testing apiClient with mocked fetch", () => {
  ...
  it("should throw an exception if server respond with an error", async() => {
    ...
    expect(testClient.fetchAndHandleResponse("POST", currentUrl)).rejects.toThrowError(CipherguardServiceUnavailableError);
  });
  ...
  it("should throw an exception if server respond with an error", async() => {
    ...
    expect(testClient.fetchAndHandleResponse("POST", currentUrl)).rejects.toThrowError(new CipherguardApiFetchError(errorMessage));
  });
  ...
  it("should throw an exception if response is not JSON but JSON is expected", async() => {
    ...
    expect(testClient.fetchAndHandleResponse("POST", currentUrl)).rejects.toThrowError(CipherguardBadResponseError);
  });
  ...
  each([
    ...
    {url: 'https://www.cipherguard.khulnasoft.com', error: assertUrlInvalidError},

    {url: new URL("file:///etc/"), error: assertUrlInvalidProtocolError},
    {url: new URL('ssh://cipherguard.khulnasoft.com'), error: assertUrlInvalidProtocolError},
    {url: new URL('chrome-extension://cipherguard.khulnasoft.com'), error: assertUrlInvalidProtocolError},
  ...
  each([
    {url: new URL("https://www.cipherguard.khulnasoft.com")},
    {url: new URL("https://www.cipherguard.khulnasoft.com/sub-folder/")},
  ...
  each([
    {id: "https://www.cipherguard.khulnasoft.com"},
    {id: uuid()},
    {id: "me"},
    {id: "test.json"},
  ...
  each([
    {
      expectedUrl: 'https://test.cipherguard.khulnasoft.com/resource.json?api-version=v2',
      url: "https://test.cipherguard.khulnasoft.com/resource",
      options: undefined
    },
    {
      expectedUrl: `https://test.cipherguard.khulnasoft.com/resource.json?api-version=v2&filter%5Bhas-users%5D=${userUuid}`,
      url: "https://test.cipherguard.khulnasoft.com/resource",
      options: {'filter[has-users]': userUuid}
    },
    {
      expectedUrl: `https://test.cipherguard.khulnasoft.com/resource.json?api-version=v2&filter%5Bhas-users%5D=${userUuid}&filter%5Bsearch%5D=something`,
      url: "https://test.cipherguard.khulnasoft.com/resource",
      options: {
    ...
    {
      expectedUrl: 'https://test.cipherguard.khulnasoft.com/resource.json?api-version=v2&contain%5Bpermissions.user.profile%5D=1',
      url: "https://test.cipherguard.khulnasoft.com/resource",
      options: {
    ...
    {
      expectedUrl: 'https://test.cipherguard.khulnasoft.com/resource.json?api-version=v2&contain%5Bpermissions.user.profile%5D=1&contain%5Bpermissions.group%5D=1',
      url: "https://test.cipherguard.khulnasoft.com/resource",
      options: {
        'contain[permissions.user.profile]': "1",
    ...
    {
      expectedUrl: `https://test.cipherguard.khulnasoft.com/resource.json?api-version=v2&filter%5Bhas-users%5D=${userUuid}&contain%5Bpermissions.user.profile%5D=1`,
      url: "https://test.cipherguard.khulnasoft.com/resource",
      options: {
        'filter[has-users]': userUuid,
        'contain[permissions.user.profile]': "1"
    ...
    {
      expectedUrl: `https://test.cipherguard.khulnasoft.com/resource.json?api-version=v2&filter%5Bhas-users%5D=${userUuid}&filter%5Bsearch%5D=something&contain%5Bpermissions.user.profile%5D=1&contain%5Bpermissions.group%5D=1`,
      url: "https://test.cipherguard.khulnasoft.com/resource",
      options: {
        'filter[has-users]': userUuid,
        'filter[search]': "something",
