...
class SelfRegistrationService {
  ...
  /**
   * Find the self registration settings using Cipherguard API
   *
  ...
  /**
   * save a the self registration settings using Cipherguard API
  ...
  /**
   * remove settings for self registration using Cipherguard API
   * @param  {String} id
   */
  async delete(id) {
    this.initClient();
