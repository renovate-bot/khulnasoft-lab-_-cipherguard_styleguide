...
describe("Entity schema isValidStringFormat", () => {
  ...
  it("isValidStringFormat works with email", () => {
    expect(EntitySchema.isValidStringFormat('ada@cipherguard.khulnasoft.com', 'email')).toBe(true);
    expect(EntitySchema.isValidStringFormat('ada+test@cipherguard.khulnasoft.com', 'email')).toBe(true);
    expect(EntitySchema.isValidStringFormat('rémy@cipherguard.khulnasoft.com', 'email')).toBe(true);
