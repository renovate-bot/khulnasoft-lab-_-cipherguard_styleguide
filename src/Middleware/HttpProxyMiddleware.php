...
{
    public const CIPHERGURD_SECURITY_PROXIES_ACTIVE_CONFIG_NAME = 'cipherguard.security.proxies.active';
    public const CIPHERGURD_SECURITY_PROXIES_TRUSTED_PROXIES_CONFIG_NAME = 'cipherguard.security.proxies.trustedProxies';
    ...
    {
        if (Configure::read(self::CIPHERGURD_SECURITY_PROXIES_ACTIVE_CONFIG_NAME)) {
            $trustedProxiesArray = Configure::read(self::CIPHERGURD_SECURITY_PROXIES_TRUSTED_PROXIES_CONFIG_NAME);
