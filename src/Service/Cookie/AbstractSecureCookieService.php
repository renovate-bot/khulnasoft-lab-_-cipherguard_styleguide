...
{
    public const CIPHERGURD_SECURITY_COOKIES_SECURE_CONFIG = 'cipherguard.security.cookies.secure';
    ...
    {
        return Configure::read(self::CIPHERGURD_SECURITY_COOKIES_SECURE_CONFIG) || $request->is('ssl');
    }
