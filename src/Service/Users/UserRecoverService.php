...
class UserRecoverService implements UserRecoverServiceInterface
{
    ...
    /**
     * @var \Cipherguard\SelfRegistration\Service\DryRun\SelfRegistrationDryRunServiceInterface
     */
     ...
     * @param \Cipherguard\SelfRegistration\Service\DryRun\SelfRegistrationDryRunServiceInterface $selfRegistrationDryRunService Service to detect if a guest can self register
     */
