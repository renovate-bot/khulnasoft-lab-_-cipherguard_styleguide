...
class HealthcheckCommand extends CipherguardCommand
{
    ...
    public function buildOptionParser(ConsoleOptionParser $parser): ConsoleOptionParser
    {
        ...
        $parser
            ...
            ->addOption('application', [
                'help' => __d('cake_console', 'Run cipherguard app tests only.'),
                'boolean' => true,
            ])
            ->addOption('jwt', [
                'help' => __d('cake_console', 'Run cipherguard JWT tests only.'),
                'boolean' => true,
            ])
    ...
    public function assertEnvironment($checks = null)
    {
        ...
        $this->assert(
            ...
            __('PHP version is too low, cipherguard need PHP {0} or higher.', Configure::read(Healthchecks::PHP_MIN_VERSION_CONFIG)) // phpcs:ignore
        );
        ...
        $this->assert(
            ...
            __('You must enable the gd or imagick extensions to use Cipherguard.'),
            [
        ...
        $this->assert(
            ...
            __('You must enable the intl extension to use Cipherguard.'),
            [
        ...
        $this->assert(
            ...
            __('You must enable the mbstring extension to use Cipherguard.'),
            [
...
//            __('You must activate the allow_url_fopen setting in php.ini to use Cipherguard.'),
//            [
...
//        );
    ...
    public function assertConfigFiles($checks = null)
    {
        ...
        $this->warning(
            $checks['configFile']['cipherguard'],
            __('The cipherguard config file is present'),
            __('The cipherguard config file is missing in {0}', CONFIG),
            [
    ...
    public function assertCore($checks = null)
    {
        ...
        $this->assert(
            ...
            __('Debug mode is on.'),
            __('Set debug = false; in {0}', CONFIG . 'cipherguard.php')
        );
        $this->assert(
            $checks['core']['cache'],
            __('Cache is working.'),
        ...
        $this->assert(
            ...
            __('Edit App.fullBaseUrl in {0}', CONFIG . 'cipherguard.php')
        );
        $this->assert(
        ...
        $this->assert(
            ...
            [
                __('Check that the domain name is correct in {0}', CONFIG . 'cipherguard.php'),
    ...
    public function assertSSL($checks = null)
    {
        ...
        $this->warning(
            ...
            [
                'Check https://help.cipherguard.khulnasoft.com/faq/hosting/troubleshoot-ssl',
            ]
        );
    ...
    public function assertDatabase($checks = null)
    {
        ...
        $this->assert(
            ...
            [
                ...
                __('See. https://www.cipherguard.khulnasoft.com/help/tech/update'),
            ]
        );
    }

    /**
     * Assert cipherguard application configuration is in order
     *
     * @param array $checks existing results
     * @return void
     */
    public function assertApplication($checks = null)
    {
        ...
        if (!isset($checks['application']['latestVersion'])) {
            $this->assert(
                false,
                __('Could connect to cipherguard repository to check versions.'),
                __('Could not connect to cipherguard repository to check versions') . ' ' .
            ...
            $this->assert(
                ...
                __('Using latest cipherguard version ({0}).', Configure::read('cipherguard.version')),
                __(
                    'This installation is not up to date. Currently using {0} and it should be {1}.',
                    Configure::read('cipherguard.version'),
        ...
        $this->assert(
            ...
            __('Cipherguard is configured to force SSL use.'),
            __('Cipherguard is not configured to force SSL use.'),
            __('Set cipherguard.ssl.force to true in {0}.', CONFIG . 'cipherguard.php')
        );
        $this->assert(
            $checks['application']['sslFullBaseUrl'],
            __('App.fullBaseUrl is set to HTTPS.'),
            __('App.fullBaseUrl is not set to HTTPS.'),
            __('Check App.fullBaseUrl url scheme in {0}.', CONFIG . 'cipherguard.php')
        );
        $this->assert(
            ...
            __('Set cipherguard.selenium.active to false in {0}.', CONFIG . 'cipherguard.php')
        );
        $this->warning(
            ...
            __('Set cipherguard.meta.robots to false in {0}.', CONFIG . 'cipherguard.php')
        );
        ...
        $this->warning(
            $selfRegistrationChecks['isRegistrationPublicRemovedFromCipherguard'],
            __('The deprecated self registration public setting was not found in {0}.', CONFIG . 'cipherguard.php'),
            __('The deprecated self registration public setting was found in {0}.', CONFIG . 'cipherguard.php'),
            __('You may remove the "cipherguard.registration.public" setting.')
        );
        $this->warning(
            ...
            [
                ...
                __('Or set the CIPHERGURD_EMAIL_VALIDATE_MX environment variable to true.'),
        ...
        $this->warning(
            ...
            __('Using non-compiled Javascript. Cipherguard will be slower.'),
            __('Set cipherguard.js.build to production in {0}', CONFIG . 'cipherguard.php')
        );
        $this->warning(
    ...
    public function assertGpgEnv($checks = null)
    {
        ...
        $this->assert(
            ...
            [
                ...
                __('You can change the location of the keyring by editing the GPG.env.setenv and GPG.env.home variables in {0}.', CONFIG . 'cipherguard.php'),// phpcs:ignore
            ]
        );
    ...
    public function assertGpg($checks = null)
    {
        ...
        if ($checks['gpg']['gpgKey']) {
            $this->assert(
                ...
                [
                    ...
                    __('See. https://www.cipherguard.khulnasoft.com/help/tech/install#toc_gpg'),
                ]
            );
        } else {
            $this->assert(
        ...
        $this->assert(
            ...
            __('The public key file is defined in {0} and readable.', CONFIG . 'cipherguard.php'),
            __('The public key file is not defined in {0} or not readable.', CONFIG . 'cipherguard.php'),
            [
        ...
        $this->assert(
            ...
            __('The private key file is defined in {0} and readable.', CONFIG . 'cipherguard.php'),
            __('The private key file is not defined in {0} or not readable.', CONFIG . 'cipherguard.php'),
            [
        ...
        $this->assert(
            ...
            __('The server key fingerprint matches the one defined in {0}.', CONFIG . 'cipherguard.php'),
            __('The server key fingerprint doesn\'t match the one defined in {0}.', CONFIG . 'cipherguard.php'),
            [
        ...
        $this->assert(
            ...
            __('The server public key defined in the {0} (or environment variables) is in the keyring.', CONFIG . 'cipherguard.php'),// phpcs:ignore
            __('The server public key defined in the {0} (or environment variables) is not in the keyring', CONFIG . 'cipherguard.php'),// phpcs:ignore
            [
    ...
    public function assertJWT($checks = null)
    {
        ...
        $this->warning(
            ...
            __('Set the environment variable {0} to true', 'CIPHERGURD_PLUGINS_JWT_AUTHENTICATION_ENABLED'),
        );
    ...
    public function assertSmtpSettings(?array $checks = null): void
    {
        ...
        $this->warning(
            ...
            [
                ...
                __('Set the CIPHERGURD_SECURITY_SMTP_SETTINGS_ENDPOINTS_DISABLED environment variable to true.'),
