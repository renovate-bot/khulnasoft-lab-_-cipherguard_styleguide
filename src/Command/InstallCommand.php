...
class InstallCommand extends CipherguardCommand
{
    ...
    public function execute(Arguments $args, ConsoleIo $io): ?int
    {
        ...
        // Winning!
        $io->nl();
        $this->success(__('Cipherguard installation success! Enjoy! ☮'), $io);
        $io->nl();
     ...
     * Dispatch to plugin CipherguardTestData.data task
     *
     * @param \Cake\Console\Arguments $args Arguments
     * @param \Cake\Console\ConsoleIo $io ConsoleIo
     * @return bool status
