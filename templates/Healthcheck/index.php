...
<div class="grid grid-responsive-12">
    <div class="row">
        <div class="col8">
            <h1><?php echo __('Cipherguard API Status') ?></h1>
            <?php
        ...
        <div class="col4 last" style="margin-top:2.8em;">
            <div class="sidebar-help transparent">
                ...
                <p>This page is available to help administrators diagnose if something is wrong with a cipherguard installation and help keeping it secure.</p>
                <p>It is also possible to perform a healt check using the command line tools as follow:</p>
                <code>
        <pre>
sudo su -s /bin/bash -c "./bin/cake cipherguard \
            ...
            <div class="sidebar-help transparent">
                ...
                <p>Hang in there! You can find more information on how to install and update cipherguard in the official online help.</p>
