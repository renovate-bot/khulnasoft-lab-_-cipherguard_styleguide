...
echo $this->element('Email/module/avatar',[
    ...
    'text' => $this->element('Email/module/avatar_text', [
        ...
        'text' => __('{0} just created an account on cipherguard!', $userFirstName)
    ])
]);

$text = '<h3>' . __('Welcome to {0}!', $userFirstName) . '</h3><br/>';
$text .= __('{0} used the self registration feature to create an account on cipherguard.', $userFullName);
